...
public class PasswordServiceImpl implements PasswordService {
	...
	public Response changePassword(ChangePasswordRequestDTO changePasswordRequestDTO) throws BankException {
		...
		Customer customer = validateRequest(changePasswordRequestDTO);
	...
	private Customer validateRequest(ChangePasswordRequestDTO changePasswordRequestDTO) throws BankException {
